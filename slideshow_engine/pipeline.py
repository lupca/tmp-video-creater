...
def _build_single_variant(
    ...
    font_path = ensure_vietnamese_font(FONT_PATH)
    ...
    tts_path = synthesize_intro_tts(intro_text)
    ...
    # Transition vao body: them whip+flash style TikTok.
